...
const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-background relative font-sans">
      ...
      <div className="hidden md:block absolute left-0 top-0 bottom-0 w-px border-l border-dotted border-border/50 ml-[calc(50%-28rem)] z-0"></div>
      <div className="hidden md:block absolute right-0 top-0 bottom-0 w-px border-r border-dotted border-border/50 mr-[calc(50%-28rem)] z-0"></div>
        ...
        <footer className="py-8 text-xs text-muted-foreground border-t border-border mt-12">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex flex-col gap-1 items-center sm:items-start text-center sm:text-left">
              <p>Designed & Developed by <span className="font-semibold text-foreground">Vedant</span></p>
            ...
            <div className="flex flex-col gap-1 items-center sm:items-end text-center sm:text-right">
              <p className="font-mono tabular-nums opacity-70">Visitors <span className="font-semibold text-foreground">#0</span></p>
              <p className="font-mono tabular-nums">Pune, India</p>
            </div>
          </div>
        </footer>
      </div>
