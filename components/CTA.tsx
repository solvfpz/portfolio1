...
const CTA: React.FC = () => {
  return (
    <div className="relative mx-auto flex w-full max-w-3xl flex-col justify-between gap-y-4 border-y border-border py-12 px-4 dark:bg-[radial-gradient(35%_80%_at_25%_0%,rgba(255,255,255,0.05),transparent)]">
      ...
      <h2 className="text-center font-semibold text-2xl md:text-3xl">Let's work together</h2>
      <p className="text-center font-medium text-muted-foreground text-sm md:text-base">
        Have a project in mind? Let's create something amazing.
      </p>
      
      <div className="flex items-center justify-center gap-4 pt-4">
        <a href="mailto:vedantlavale@gmail.com" className="px-6 py-2 rounded-md border border-border text-sm font-medium hover:bg-accent transition-colors">
          Email Me
        </a>
        <a href="#" className="px-6 py-2 rounded-md bg-primary text-primary-foreground text-sm font-medium hover:opacity-90 transition-opacity flex items-center gap-2">
